...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateQuestionInputWithOutputRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Created question input and output IDs",
                        "schema": {
                            "type": "string"
                        }
                    },
    ...
    "definitions": {
        ...
        "model.CreateQuestionInputWithOutputRequest": {
            ...
            "properties": {
                "inputs": {
                    "description": "Input va outputlar uchun slice",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.InputOutputCreate"
                    }
                },
                "question_id": {
                    "type": "string"
